...
def _disp_org_acc(org_acc, curr_user_acc, curr_user_org_acc, **returned_values):
    ...
    if org_acc.is_repository:
        ...
        if "form_repo_settings" in returned_values:
            ...
            # user is NOT a Jisc admin and Account is NOT live (i.e. is a Test account)
...
def notifications(repo_uuid, curr_user=None, cu_org_acc=None):
    ...
    return render_template('/account/note_history.html',
                           ...
                           note_details_url=url_for("admin.note_details")
                           )
    ...
    try:
        ...
        if params_loaded is not None:
            ...
            err_msg = ('There was an error with your upload; no changes were made. Please check that your file is in '
                       ...
                       'If the problem persists please contact help@YYYY.ac.uk')
                ...
                if can_check_pwd:
                    ...
                    if user_acc.check_password(password):
                        ...
                        # 2 Step login - need to create & email a access code and set login cookie
                            ...
                            msg = f"An access code, valid for 5 minutes, has been emailed to you at: <strong>{user_email}</strong>.<br><br>Check your Junk folder if you do not see it in your Inbox. If it does not arrive, please email <a href=\"mailto:help@YYYY.ac.uk?subject=Publications%20Router%20login%20token%20-%20email%20did%20not%20arrive&body=The%20expected%20login%20token%20has%20not%20arrived%20at%20email%20address:%20'{user_email}'.\">help@YYYY.ac.uk</a>, mentioning Publications Router in the email subject line."
                            flash(msg, 'info+html')
    ...
    if request.method == 'GET':
        ...
        if username:
            ...
            if user_acc:
                ...
                email_text = f'please email <a href="mailto:help@YYYY.ac.uk?subject=Publications%20Router%20password%20reset%20request%20-%20{{}}&body={email_body}">help@YYYY.ac.uk</a>, mentioning Publications Router in the email subject line'
