-- Staging: Update notification records `links_json` column to replace "url" values by "cloc" values for Router links
USE jper;
...
-- Perform the update (NB. this version allows for v3 & v4 API entries, due to early test implementation)
-- https://XXXX.jisc.ac.uk
UPDATE notification_cpy
SET links_json = REGEXP_REPLACE(links_json, '"url":"https://XXXX.jisc.ac.uk/api/v(3|4)/notification/[0-9]+/content/?','"cloc":"')
